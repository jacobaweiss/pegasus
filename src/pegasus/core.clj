...
(defn remove-peg
  "Removes the peg at the position"
  [board pos]
  (assoc-in board [pos :pegged] false))

(defn place-peg
  "Places a peg at the position"
  [board pos]
...
(defn valid-moves
  "Return a map of all the valid moves for pos, where the key
...
(defn row-padding
  "String of spaces to pad the beginning of the row to center it"
  [row-num rows]
...
; Interaction
(defn letter->pos
  "Converts the letter string into a corresponding position number"
  [letter]
...
(defn characters-as-strings
  "Given a string, return the individual letters as strings"
  [string]
...
(defn -main
  [& args]
  (println "Let's play the peg game!")
  (prompt-rows))
